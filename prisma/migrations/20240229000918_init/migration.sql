-- CreateEnum
CREATE TYPE "MsgType" AS ENUM ('AUDIO', 'POST', 'PHOTO', 'TEXT');
...
CREATE TABLE "User" (
    ...
    "image" TEXT,
    "userName" TEXT NOT NULL DEFAULT substring('1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ' FROM (floor(random() * 62) + 1)::integer FOR 10),
    "profilePhoto" TEXT,
    "userId" TEXT,
...
CREATE TABLE "Message" (
    ...
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "text" TEXT NOT NULL,
    "isReadByRecievers" TEXT[] DEFAULT ARRAY[]::TEXT[],
